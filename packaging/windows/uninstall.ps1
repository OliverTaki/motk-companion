...
$stopScript = Join-Path $installPath '_internal\scripts\stop-companion.ps1'
if (-not (Test-Path -LiteralPath $stopScript -PathType Leaf)) { $stopScript = Join-Path $installPath 'scripts\stop-companion.ps1' }
